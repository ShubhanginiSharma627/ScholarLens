...
/// Typography system for ScholarLens with consistent text styles and spacing
class AppTypography {
  // Font family
  ...
  // Headline text styles (for section headings)
  ...
  // Title text styles (for card titles, button text)
  ...
  // Body text styles (for content, descriptions)
  ...
  // Label text styles (for form labels, captions)
...
/// Extension to add typography methods to TextStyle
