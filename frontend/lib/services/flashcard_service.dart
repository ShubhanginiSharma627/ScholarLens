...
/// Service for managing flashcards with CRUD operations and spaced repetition
class FlashcardService {
  ...
  /// Updates flashcard difficulty and schedules next review
  ...
  /// Gets flashcard statistics for a subject
  ...
  Future<void> importFlashcards(List<Map<String, dynamic>> flashcardsJson) async {
    ...
    // Add new flashcards (avoid duplicates by ID)
  ...
  /// Private method to save flashcards to storage
  ...
  /// Private method to update subjects list
...
/// Statistics for flashcards in a subject
